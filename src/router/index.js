...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: '/client-configs',
        name: 'Configurations',
        component: () => import('@/views/pages/Configurations.vue'),
      },
      {
        path: '/devices',
        name: 'Devices',
...

      {
        path: '/create-task',
        name: 'CreateTask',
        component: () => import('@/views/pages/CreateTask.vue'),
      },

      {
        path: '/task-queue',
        name: 'TaskQueue',
        component: () => import('@/views/pages/TaskQueue.vue'),
      },
...
router.beforeEach((to, from, next) => {
  ...
  if (to.name !== 'Login' && !token) {
    console.log("Estoy dentro y no tengo token"); 
    next({ name: 'Login' })
  }
  else next()
})
